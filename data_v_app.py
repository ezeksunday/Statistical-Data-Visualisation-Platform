...
class App(customtkinter.CTk):
        def __init__(self):
            ...
            self.st=ttk.Style()
            self.st.configure('TNotebook.Tab', font='cambria 14 bold')
            
            self.st.configure("TCombobox", fieldbackground= "blue", background= "white")
            self.st.configure('Treeview',font='cambria 13 ')
            self.st.configure('Treeview.Heading',font='cambria 14 bold')
            ...
            self.tk_img=self.tk_img.resize((self.width-40,self.height-50))
            ...
            # File Menus
            self.menu_btn=CTkButton(self.top_frame,corner_radius=5,cursor='hand2',text='Files',fg_color='white',hover_color='lightgray',text_font=('cambria','14'),width=10,text_color='black',command=self.file_menu)
            #self.menu_btn.bind('<Enter>',self.file_menu)   
            self.menu_btn.pack(side=LEFT,padx=1,pady=5)
            
            # Statistics Menu
            self.stat_btn=CTkButton(self.top_frame,corner_radius=5,cursor='hand2',text='Statistical Data',fg_color='white',hover_color='lightgray',text_font=('cambria','14'),width=10,text_color='black',command=self.stat_menu)
            self.stat_btn.pack(side=LEFT,padx=1,pady=5)
           
           
            
            # 2 Dimensional Charts
            self.two_d_btn=CTkButton(self.top_frame,corner_radius=5,cursor='hand2',text='Select 2D Chart',fg_color='white',hover_color='lightgray',text_font=('cambria','14'),width=10,text_color='black',command=self.two_d_menu)
            self.two_d_btn.pack(side=LEFT,padx=1,pady=5)
            
            
            # 3 Dimensional Charts
            self.three_d_btn=CTkButton(self.top_frame,corner_radius=5,cursor='hand2',text='Select 3D Chart',fg_color='white',hover_color='lightgray',text_font=('cambria','14'),width=10,text_color='black',command=self.three_d_menu)
            self.three_d_btn.pack(side=LEFT,padx=1,pady=5)
            #self.three_d_btn.bind('<Enter>',self.three_d_menu)


            self.pre_processing_btn=CTkButton(self.top_frame,corner_radius=5,cursor='hand2',text='Preprocess data',fg_color='white',hover_color='lightgray',text_font=('cambria','14'),width=10,text_color='black',command=self.pre_processing_menu)
            ...
            self.lab2=CTkLabel(self.top_frame,text='Online Dataset:',text_color='black',text_font=('cambria','14',"bold"),corner_radius=0).place(relx=0.565,rely=.255)
            ...
            self.online_entry.place(relx=.652,rely=.2)
            ...
            self.online_download_button.place(relx=.94,rely=.2)
            ...
            self.help_btn.place(relx=.97,rely=.2)
            ...
            self.ls = Listbox(self.attribute_frame,bg='white',bd=0,font='cambria 14 bold',highlightbackground='white',
            ...
            self.down.place(relx=0,rely=.6,height=30,width=380)
            
            self.sec_frame = Listbox(self.s_info_frame,bg='white',bd=0,font='cambria 14 bold',highlightbackground='white',
                              highlightcolor='white',selectborderwidth=0,selectbackground='white',selectforeground='black',
                              activestyle='none')
            ...
            self.mapp=CTkFrame(self.main_app,width=920,height=450,fg_color='white',corner_radius=0,border_width=2,border_color='lightgray')
            ...
            self.x_chooser=ttk.Combobox(self.main_app,state='readonly',width=15,font='cambria 12 bold',textvariable=self.x_column)
            ...
            self.y_chooser=ttk.Combobox(self.main_app,state='readonly',width=15,font='cambria 12 bold',textvariable=self.y_column)
            ...
            self.hue=ttk.Combobox(self.main_app,state='readonly',width=15,font='cambria 12 bold',textvariable=self.z_column)
            self.hue['values']=(['Choose hue column'])
            self.hue.current(0)
            self.graph_type=CTkButton(self.main_app,width=150,text_font=('cambria','14'),text_color='white',text='GRAPH TYPE')
            ...
            self.optional_label=CTkLabel(self.main_app,corner_radius=0,text='Optional',fg_color='white',text_font=('cambria','14'),text_color='black')
            self.row_start_label=CTkLabel(self.main_app,corner_radius=0,text='Row start:',fg_color='white',text_font=('cambria','14'),text_color='black')
            self.row_end_label=CTkLabel(self.main_app,corner_radius=0,text='Row End:',fg_color='white',text_font=('cambria','14'),text_color='black')
            self.start_entry=CTkEntry(self.main_app,corner_radius=5,fg_color='white',text_font=('cambria','14'),text_color='black',width=90)
            self.end_entry=CTkEntry(self.main_app,corner_radius=5,fg_color='white',text_font=('cambria','14'),text_color='black',width=90)
            
            self.x_entry_label=CTkLabel(self.main_app,corner_radius=0,text='Select X values to plot:',fg_color='white',text_font=('cambria','14'),text_color='black')
            self.y_entry_label=CTkLabel(self.main_app,corner_radius=0,text='Select Y values to plot:',fg_color='white',text_font=('cambria','14'),text_color='black')
            self.z_entry_label=CTkLabel(self.main_app,corner_radius=0,text='Select Hue column:',fg_color='white',text_font=('cambria','14'),text_color='black')
            self.selected_graph_type=CTkLabel(self.main_app,corner_radius=0,text='Selected graph',fg_color='white',text_font=('cambria','14'),text_color='black')
            
            self.plot_button=CTkButton(self.main_app,text='PLOT', text_font=('cambria','14'),fg_color=self.btn_for_cv,hover_color='#2DC703',text_color='white',command=self.main_plot)
            ...
            self.main_app.create_window((2,720),window=self.data_h,anchor=NW)
            ...
            self.hold.place(rely=.1,height=250,width=950)
            self.data_name=Label(self.data_h,text='',font='Cambria 14',bg='white')
            self.data_name.place(relx=0.25,rely=0)

            self.data_reupload=CTkButton(self.data_h,text='SEE ALL DATA',text_font='Cambria 14',text_color='white',corner_radius=2,command=self.open_reupload)
        ...
        def sum_up(self) :
            self.df.sum()       
        def file_menu(self):
            popup=Menu(self.top_frame,tearoff=False,font=('cambria','14'),bd=0,activebackground='#000000',activeforeground='#ffffff',bg='white')
            try:
                popup.add_command(label="New Project",command=self.new_pro)
                popup.add_command(label="Upload dataset",command=self.open)
                popup.tk_popup(70,100)
            finally:
                popup.grab_release()
        def stat_menu(self):
            popup=Menu(self.top_frame,tearoff=False,font=('cambria','14'),bd=0,activebackground='#000000',activeforeground='#ffffff',bg='white')
            try:
                ...
                popup.add_separator()
                sum_menu = Menu(popup, tearoff=0,font=('cambria','14'),bd=0,activebackground='#000000',activeforeground='#ffffff',bg='white')
                ...
                popup.add_separator()
                # add a submenu
                other_menu = Menu(popup, tearoff=0,font=('cambria','14'),bd=0,activebackground='#000000',activeforeground='#ffffff',bg='white')
        ...
        def two_d_menu(self):
            ...
            try:
                # Basic plots
                basic_menu = Menu(popup, tearoff=0,font=('cambria','14'),bd=0,activebackground='#000000',activeforeground='#ffffff',bg='white')
                ...
                # Stat plots
                stat_menu = Menu(popup, tearoff=0,font=('cambria','14'),bd=0,activebackground='#000000',activeforeground='#ffffff',bg='white')
                
                pie_menu = Menu(popup, tearoff=0,font=('cambria','14'),bd=0,activebackground='#000000',activeforeground='#ffffff',bg='white')
                def p():
                ...
                # Array plots
                array_menu = Menu(popup, tearoff=0,font=('cambria','14'),bd=0,activebackground='#000000',activeforeground='#ffffff',bg='white')
    ...
    #############================================OPEN FILE FUNCTION=============###############
        def search_online_fnc(self):
            try:
                ...
                self.hue['values']=(['Choose hue column'])
                self.hue.current(0)
                self.graph_type.config(text='GRAPH TYPE')
                self.df=''
                ...
                if name.endswith('.csv'):
                    self.df=pd.read_csv(self.online_url,ssl=ssl_context)
     ...
     ######################STATISTICAL INFORMATION ON EACH UPLOADED DATASET###########
        ...
        def column_chooser(self):
            try:
                ...
                head=list(self.df.columns)
                self.col_names=ttk.Combobox(self.frame_1,state='readonly',width=15,font='cambria 12 bold',textvariable=self.col_n)
    ...
    #--------------------------------------Bar plot-----------#             
        ...
        def count_plot(self):
            try:
                ...
                if self.z_entry_val.get()=='': 
                    sns.countplot(data=self.df,x=x,ax=self.plot1,color='#4C72B0')
                else:
                    z=self.df.loc[:,self.z_entry_val.get()]
                    sns.countplot(data=self.df,x=x,ax=self.plot1,hue=z,color='#4C72B0')
        ...
        def pie_plot(self):
            try:
                ...
                self.plot1.pie(y,labels=x,autopct='%.1f%%',textprops = dict(fontsize=10,color ="black"))
        ...
        def dou_plot(self):
            try:
                ...
                self.plot1.pie(y,labels=x,autopct='%1.1f%%', pctdistance=0.85,explode=explodes,textprops = dict(fontsize=10,color ="black"))
     ...
     ############----------------Clearing Functions-------------###########
        ...
        def column_to_drop(self):
            try:
                ...
                self.col_n=StringVar()
                head=list(self.df.columns)
                self.s_cols=ttk.Combobox(self.drop_c,state='readonly',width=15,font='cambria 12 bold',textvariable=self.col_n)
        ...
        def row_to_drop(self):
            try:
                ...
                head=list(self.df.columns)
                self.s_rows=ttk.Combobox(self.drop_r,state='readonly',width=15,font='cambria 12 bold',textvariable=self.row_n)
        ...
        def row_index_to_drop(self):
            try:
                ...
                self.drop_r_i.title('ENTER ROWS TO BE LEFT')
                self.photo=PhotoImage(file='images/data.png')
    ...
    ####################==============All graphs  Visualizations==================######################### 
        ...
        def read_me(self):
            import subprocess
            filename = "readme.txt"
            subprocess.call(["open", "-a", "TextEdit", os.path.abspath(filename)])
